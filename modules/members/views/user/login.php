    ...
    <div class="box-main-register m-auto">
        ...
        <div class="form-login-container">
            ...
            <div class="login-res d-flex align-items-center justify-content-between">
                ...
                <div class="forgot">
                    <a href="<?php echo FSRoute::_('index.php?module=members&view=user&task=forgot') ?>" class="fw-bold text-red ms-2" data="register-telephone">
                        <?php echo FSText::_('Quên mật khẩu ?') ?>
                    </a>
                </div>
            </div>
        </div>
