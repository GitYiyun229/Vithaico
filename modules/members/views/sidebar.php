...
<div class="d-flex align-items-center gap-2 mb-3 user-name-sidebar">
    <div class="col-3 ps-4">
        <div class="">
            <img src="<?php echo URL_ROOT . $this->userImage ?>" alt="user" class="img-fluid img-image d-none">
            <input type="file" class="input-upload-image d-none" name="image_menu" id="image_menu" accept=".png, .jpg, .jpeg" data-img="img-image">
            <a href="" class="btn-upload-image">
