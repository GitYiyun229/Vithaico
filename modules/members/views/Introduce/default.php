    ...
    <div class="page-member">
        ...
        <div class="page-side">
            <div class="page-content page-address p-4 bg-white page-border-radius <?php echo empty($list) ? 'page-address-empty' : '' ?>">
                <div class="page-title mb-3 text-uppercase fs-5 fw-bold"><?php echo FSText::_('Thống kê danh sách F1') ?></div>

                <div class="user_f1">
                    <div class="user_f1_title d-flex justify-content-between">
                        <div class="user_f1_title_item text-uppercase"><?php echo FSText::_('stt') ?></div>
                        <div class="user_f1_title_item text-uppercase"><?php echo FSText::_('Họ tên') ?></div>
                        <div class="user_f1_title_item text-uppercase"><?php echo FSText::_('Số điện thoại') ?></div>
                        <div class="user_f1_title_item text-uppercase"><?php echo FSText::_('Email') ?></div>
                        <div class="user_f1_title_item text-uppercase"><?php echo FSText::_('Ngày đăng ký') ?></div>
                    </div>
