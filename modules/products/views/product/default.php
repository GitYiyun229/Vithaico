        ...
        <div class="section-image">
            <div class="box-left_image">
                <div class="slider-nav">
                    ...
                    <div class="item">
                        <img src="<?php echo image_replace_webp(URL_ROOT . $item->image, 'larges') ?>"
                            onerror="this.src='/images/not_picture.png'" alt="<?php echo $data->name ?>"
                            class="img-fluid">
                    </div>
                    <?php } ?>
                </div>
                ...
                <div class="p-code-status">
                    ...
                    <div class="<?php echo $data->status_prd == 4 ? 'p-status-out' : 'p-status-in' ?>">
                        ...
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.5 4.5L4.5 13.5" stroke="#E71313" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M4.5 4.5L13.5 13.5" stroke="#E71313" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <?php } else { ?>
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="p-line d-flex align-items-center gap-2">
                        ...
                        <div class="p-line-content d-flex align-items-center gap-4 border rounded-2">
                            <div class="p-quantity d-flex align-items-center">
                                ...
                                <input class="form-control border-bottom-0 border-top-0 rounded-0 text-center"
                                    id="order-quantity" type="number" value="1" min="1"
                                    max="<?php echo $data->quantity ?>">
