    ...
    success: function (result) {
      ...
      if (result.newItem) {
        ...
        <div class="cart-hover-item position-relative">
            <a href="${result.newItem.url}" class=""><img src="${result.newItem.image}" alt="${result.newItem.product_name}" class="img-fluid"></a>
            <div>
                <a href="${result.newItem.url}">
                    ...
                    <div class="item-price d-flex flex-wrap align-items-center justify-content-between">
                        <p>${result.newItem.price.toString().replace(/\B(?=(\d{3})+(?!\d))/g,".")}
                        <span class="span-price-origin">${result.newItem.price_origin.toString().replace(/\B(?=(\d{3})+(?!\d))/g,".")}</span>
                        </p>
