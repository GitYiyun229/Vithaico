...
<?php } elseif (@$products['mobile']) {
    ...
    $gif_arr = explode(';', $gif);
    ?>
    <h3 class="title_user" style="text-align: center;text-transform: uppercase;">Thông tin thành viên</h3>

    <div class="item">
        <p class="name_user"><b>Họ và tên</b> : <?php echo $products['name'] ?></p>
        <p class="phone_user"><b>Số điện thoại</b> : <?php echo $products['mobile'] ?></p>
        <p class="total_user"><b>Tổng số tiền đã mua</b> : <?php echo format_money($products['totalAmount']) ?></p>
...
<!--	--><?php //} ?>
<div class="modal_bot">
    <button type="button" class="btn btn-secondary" id="close-cart">Đóng</button>
</div>
