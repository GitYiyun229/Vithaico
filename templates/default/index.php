...
<div id="app">
    ...
    <header class="bg-white">
        <div class="container header-container d-flex align-items-center justify-content-between">
            ...
            <div class="block-members_cart_lang d-flex align-items-center gap-3">
...
<div class="mb-5 text-center"><?php echo FSText::_('Chào mừng bạn đến với ShopUSA !') ?>
</div>
<form action="" method="POST" id="form-login">
    <div class="mb-4">
        <input type="text" class="form-control" name="userlog" id="userlog" autocomplete
            placeholder="<?php echo FSText::_('Email/Số điện thoại') ?>">
    </div>
    ...
    <div class="mb-4">
        <a href="" id="btn-submit-login"
            class="form-submit text-uppercase d-flex align-items-center justify-content-center fw-medium"><?php echo FSText::_('Đăng nhập') ?></a>
    </div>
    ...
    <input type="hidden" name="redirect"
        value="<?php echo $Itemid == 1 ? URL_ROOT : URL_ROOT . substr($_SERVER['REQUEST_URI'], strlen(URL_ROOT_REDUCE)) ?>" />
</form>
...
<div class="mb-5 d-flex gap-3">
    <a href="<?php echo FSRoute::_("index.php?module=members&view=facebook") ?>"
        class="btn-log-with w-100 d-flex align-items-center justify-content-center gap-2">
        Facebook
        <img src="/images/facebook.svg" alt="facebook" class="img-fluid">
    </a>
    <a href="<?php echo FSRoute::_("index.php?module=members&view=google") ?>"
        class="btn-log-with w-100 d-flex align-items-center justify-content-center gap-2">
        Google
...
<div class="d-flex align-items-center justify-content-between">
    <div><?php echo FSText::_('Bạn là khách hàng mới?') ?> <a href="" class="fw-bold modal-member-tab text-red"
            data="register-telephone"><?php echo FSText::_('Đăng ký') ?></a></div>
...
<div class="layout-modal layout-register-telephone" style="display: none;">
    ...
    <div class="form-register-container">
        <form action="" method="POST" id="form-register">
            <div class="mb-2  position-relative">
                ...
                <div class="mb-4">
                    <input type="text" class="form-control" name="nameregister" id="nameregister" autocomplete
                        placeholder="<?php echo FSText::_('Nhập họ và tên của bạn') ?>">
                </div>
                <div class="mb-4">
                    <input type="text" class="form-control" name="emailregister" id="emailregister" autocomplete
                        placeholder="<?php echo FSText::_('Nhập email của bạn') ?>">
                </div>
                <div class="mb-4 d-flex align-items-center justify-content-center w-100 position-relative">
                    <div class="w-100">
                        <input type="password" class="form-control w-100" name="passregister" id="passregister"
                            autocomplete placeholder="<?php echo FSText::_('Mật khẩu') ?>">
                        <a href="" class="toggle-password">
                ...
                <div class="mb-4 d-flex align-items-center justify-content-center  position-relative w-100">
                    <div class="w-100">
                        <input type="text" class="form-control w-100" name="repassregister" id="repassregister"
                            autocomplete placeholder="<?php echo FSText::_('Nhập lại mật khẩu của bạn') ?>">
                        <a href="" class="toggle-password">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="mt-4 mb-4">
                <a href="javascript:void(0)" id="btn-submit-register"
                    class="form-submit text-uppercase d-flex align-items-center justify-content-center fw-medium">
                    <?php echo FSText::_('Đăng ký') ?>
                </a>
            </div>
            <?php echo csrf::displayToken(); ?>
    ...
    <div class="text-center">
        <?php echo FSText::_('Bạn đã có tài khoản?') ?> <a href="" class="fw-bold modal-member-tab text-red"
            data="login"><?php echo FSText::_('Đăng nhập') ?></a>
    </div>
</div>
<div class="layout-modal layout-register-success" style="display: none;">
    <div class="text-center mb-5">
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M18.0837 28.0001L24.687 34.6034L37.917 21.3967M28.0003 51.3334C40.8337 51.3334 51.3337 40.8334 51.3337 28.0001C51.3337 15.1667 40.8337 4.66675 28.0003 4.66675C15.167 4.66675 4.66699 15.1667 4.66699 28.0001C4.66699 40.8334 15.167 51.3334 28.0003 51.3334Z"
                stroke="#3BA500" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    </div>
    ...
    <div class="mb-4 text-center">
        Bạn sẽ được chuyển hướng đến ShopUSA trong <p class="re-send-count-down-callback"></p>
        giây.
    </div>
    <a href="<?php echo URL_ROOT ?>"
        class="form-submit text-uppercase d-flex align-items-center justify-content-center fw-medium"><?php echo FSText::_('Quay lại trang chủ') ?></a>
</div>

<div class="layout-modal layout-password" style="display: none;">
    <a href="" class="modal-member-tab" data="login">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.9998 19.92L8.47984 13.4C7.70984 12.63 7.70984 11.37 8.47984 10.6L14.9998 4.07996"
    ...
    <div class="mb-5">
        <?php echo FSText::_('Vui lòng nhập thông tin tài khoản để lấy lại mật khẩu') ?></div>
</div>
</div>
