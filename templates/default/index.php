                    ...
                    <div class="members_header">
                        ...
                        <div class="box_members_click">
                            <?php if ($user->userID) { ?>
                                ...
                                <a class="btn-guest" href="<?php echo FSRoute::_("index.php?module=members&view=introduce") ?>">
                                ...
                                <a class="btn-guest" href="<?php echo FSRoute::_("index.php?module=members&view=ordersf1") ?>">
                                ...
                                <a class="btn-guest" href="<?php echo FSRoute::_("index.php?module=members&view=statistics") ?>">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="p-5 grid-content">
                            <div class="layout-modal layout-register-success" style="display: none;">
                                ...
                                <div class="mb-4 text-center">
                                    Bạn đã tạo thành công tài khoản với số điện thoại <br>
