...
<div id="app">
    ...
    <header class="bg-white">
        <div class="container header-container d-flex align-items-center justify-content-between">
            <button class="btn-menu_mobile" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"
                aria-controls="offcanvasTop">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 12H21M3 6H21M3 18H15" stroke="black" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </button>
            <a href="<?php echo URL_ROOT ?>" title="<?php echo $config['site_name'] ?>">
                <img src="<?php echo URL_ROOT . $config['logo'] ?>" width="100" height="48.5"
                    alt="<?php echo $config['site_name'] ?>" class="img-fluid img-logo">
            </a>
                ...
                <div class="cart_header d-flex align-items-center justify-content-end">
                    ...
                    <div class="cart-hover">
                            ...
                            <div class="cart-hover-item position-relative">
                                ...
                                <div>
                                    <a href="<?php echo $item['url'] ?>">
                                        ...
                                        <div
                                            class="item-price d-flex flex-wrap align-items-center justify-content-between">
                                            <p><?php echo format_money($item['price']) ?>
                                                <span
                                                    class="span-price-origin"><?php echo format_money($item['price_old']) ?></span>
                                            </p>
                                            <p><?php echo 'x ' . ($item['quantity']) ?></p>
                                        </div>
                                    </a>
                                </div>
                                <a href="" class="delete-cart position-absolute top-0 end-0"
                                    data-id="<?php echo $item['product_id'] ?>">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.6201 2.38L2.38013 11.62M2.38013 2.38L11.6201 11.62"
                        ...
                        <div class=" cart-hover-footer">
                            <div class="text-tamtinh text-center"><span>Tạm tính</span><b
                                    class="cart-text-quantity"><?= format_money($total_money_cart) ?></b></div>
                            <p class="mt-3 mb-3 text-center">Mã vận chuyển, thuế và giảm giá được tính khi thanh toán.
                            </p>
                            <a class="text-center"
                                href="<?php echo FSRoute::_('index.php?module=products&view=cart') ?>"><?php echo FSText::_('Thanh toán') ?></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box_members_click">
                        ...
                        <a href="<?php echo FSRoute::_('index.php?module=members&view=user&task=login') ?>"
                            ...
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M7.41675 6.29995C7.67508 3.29995 9.21675 2.07495 12.5917 2.07495H12.7001C16.4251 2.07495 17.9167 3.56662 17.9167 7.29162V12.725C17.9167 16.45 16.4251 17.9416 12.7001 17.9416H12.5917C9.24175 17.9416 7.70008 16.7333 7.42508 13.7833M1.66675 9.99995H12.4001M10.5417 7.20828L13.3334 9.99995L10.5417 12.7916"
                        ...
                        <div class="user_login_btn user_header_btn d-flex gap-2">
                            ...
                            <div>
                                ...
                                <a class="btn-guest-2"
                                    href="<?php echo FSRoute::_("index.php?module=members&view=log&task=logout") ?>">
                                    <span>
                        ...
                        <a class="btn-guest" href="<?php echo FSRoute::_("index.php?module=members&view=dashboard") ?>">
                            <svg width="18" height="20" viewBox="0 0 18 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M5.66667 10.1667H11.5M5.66667 13.5H9.31667M12.3333 3.35002C15.1083 3.50002 16.5 4.52502 16.5 8.33335V13.3334C16.5 16.6667 15.6667 18.3334 11.5 18.3334H6.5C2.33333 18.3334 1.5 16.6667 1.5 13.3334V8.33335C1.5 4.53335 2.89167 3.50002 5.66667 3.35002M7.33333 5.00002H10.6667C12.3333 5.00002 12.3333 4.16669 12.3333 3.33335C12.3333 1.66669 11.5 1.66669 10.6667 1.66669H7.33333C6.5 1.66669 5.66667 1.66669 5.66667 3.33335C5.66667 5.00002 6.5 5.00002 7.33333 5.00002Z"
                        ...
                        <a class="btn-guest" href="<?php echo FSRoute::_("index.php?module=members&view=dashboard") ?>">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M7.91675 11.4584C7.91675 12.2667 8.54176 12.9167 9.30843 12.9167H10.8751C11.5417 12.9167 12.0834 12.35 12.0834 11.6417C12.0834 10.8834 11.7501 10.6084 11.2584 10.4334L8.75008 9.55836C8.25842 9.38336 7.92509 9.11669 7.92509 8.35002C7.92509 7.65002 8.46674 7.07503 9.13341 7.07503H10.7001C11.4667 7.07503 12.0918 7.72503 12.0918 8.53336M10.0001 6.25002V13.75M18.3334 10C18.3334 14.6 14.6001 18.3334 10.0001 18.3334C5.40008 18.3334 1.66675 14.6 1.66675 10C1.66675 5.40002 5.40008 1.66669 10.0001 1.66669M18.3334 5.00002V1.66669M18.3334 1.66669H15.0001M18.3334 1.66669L14.1667 5.83335"
                                    stroke="#757575" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        ...
                        <a class="btn-guest"
                            ...
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M6.41658 5.30001C6.67492 2.30001 8.21658 1.07501 11.5916 1.07501H11.6999C15.4249 1.07501 16.9166 2.56668 16.9166 6.29168V11.725C16.9166 15.45 15.4249 16.9417 11.6999 16.9417H11.5916C8.24158 16.9417 6.69992 15.7333 6.42492 12.7833M11.4999 9.00001H2.01659M3.87492 6.20835L1.08325 9.00001L3.87492 11.7917"
                                    stroke="#757575" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                ...
                <div class="grid_footer-col">
                    ...
                    <div class="info_company">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M8.00046 8.95301C9.14921 8.95301 10.0805 8.02176 10.0805 6.87301C10.0805 5.72426 9.14921 4.79301 8.00046 4.79301C6.8517 4.79301 5.92046 5.72426 5.92046 6.87301C5.92046 8.02176 6.8517 8.95301 8.00046 8.95301Z"
                                stroke="#A3A3A3" />
                            <path
                                d="M2.41379 5.65968C3.72712 -0.113657 12.2805 -0.106991 13.5871 5.66634C14.3538 9.05301 12.2471 11.9197 10.4005 13.693C9.06046 14.9863 6.94046 14.9863 5.59379 13.693C3.75379 11.9197 1.64712 9.04634 2.41379 5.65968Z"
                                stroke="#A3A3A3" />
                        </svg>
                        <p>
                    ...
                    <div class="info_company">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M11.334 5.99967L9.24731 7.66634C8.56065 8.21301 7.43398 8.21301 6.74731 7.66634L4.66732 5.99967M11.334 13.6663H4.66732C2.66732 13.6663 1.33398 12.6663 1.33398 10.333V5.66634C1.33398 3.33301 2.66732 2.33301 4.66732 2.33301H11.334C13.334 2.33301 14.6673 3.33301 14.6673 5.66634V10.333C14.6673 12.6663 13.334 13.6663 11.334 13.6663Z"
                                stroke="#A3A3A3" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <p>
                ...
                <div class="info">
                    <a href="">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12.808 4.65602H14.312V2.11202C13.5838 2.0363 12.8521 1.99892 12.12 2.00002C9.94399 2.00002 8.456 3.32802 8.456 5.76002V7.85601H6V10.704H8.456V18H11.4V10.704H13.848L14.216 7.85601H11.4V6.04002C11.4 5.20002 11.624 4.65602 12.808 4.65602Z"
                                fill="#A3A3A3" />
                        </svg>
                    </a>
                    <a href=""><svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M14.6009 2.77002H17.0544L11.6943 8.8962L18 17.2326H13.0627L9.19565 12.1766L4.77085 17.2326H2.31595L8.04903 10.6799L2 2.77002H7.06261L10.5581 7.39136L14.6009 2.77002ZM13.7399 15.7641H15.0993L6.32391 4.16139H4.86504L13.7399 15.7641Z"
                                fill="#A3A3A3" />
                        </svg>
                    </a>
                    <a href=""><svg width="20" height="20" viewBox="0 0 20 20" fill="none"
    ...
    <div class="side-left_btn">
        <a class="circle-tel d-flex align-items-center justify-content-center"
            href="tel:<?php echo $config['hotline'] ?>">
    ...
    <div class="side-right_btn">
        ...
        <a class="" href="#" id="go-top">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    d="M24.1472 20.262C24.1937 20.2763 24.2424 20.286 24.2874 20.3048C24.4097 20.3557 24.4307 20.385 24.5312 20.4675L30.5342 26.4712C30.5964 26.547 30.6594 26.6243 30.6969 26.7143C30.8289 27.0323 30.7082 27.4335 30.4209 27.6255C30.1749 27.7897 29.8329 27.7897 29.5869 27.6255C29.5457 27.5985 29.5112 27.5633 29.4729 27.5325L24.0002 22.0598L18.5282 27.5325L18.4142 27.6255C18.3707 27.6488 18.3294 27.6758 18.2844 27.6945C17.9672 27.8265 17.5682 27.7095 17.3732 27.4185C17.2089 27.1725 17.2089 26.8305 17.3732 26.5845C17.4009 26.544 17.4354 26.5088 17.4669 26.4713L23.4699 20.4675C23.5082 20.4368 23.5427 20.4015 23.5839 20.3745C23.6657 20.3198 23.7572 20.2815 23.8539 20.262C23.9499 20.2433 24.0489 20.253 24.1472 20.262Z"
                    fill="white" />
            </svg>
    ...
    <div class="d-flex align-items-center justify-content-center w-100 h-100 ">
        <div id="flash-message" class="p-4 text-center flash-message">
            <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <path
                    d="M21.75 26L24.58 28.83L30.25 23.17M26 36C31.5 36 36 31.5 36 26C36 20.5 31.5 16 26 16C20.5 16 16 20.5 16 26C16 31.5 20.5 36 26 36Z"
                    stroke="#3BA500" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="svg-error">
                ...
                <path
                    d="M23.17 28.83L28.83 23.17M28.83 28.83L23.17 23.17M26 36C31.5 36 36 31.5 36 26C36 20.5 31.5 16 26 16C20.5 16 16 20.5 16 26C16 31.5 20.5 36 26 36Z"
                    stroke="#E81B2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
