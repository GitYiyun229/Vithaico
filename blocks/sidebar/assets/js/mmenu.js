!function (e) {
    ...
    var S = function () {
        ...
        return e.prototype.openPanel = function (e, t) {
            ...
            if (this.trigger("initNavbar:before", [e]), !_(e, ".mm-navbar").length) {
                ...
                if (e.dataset.mmParent ? n = g(this.node.pnls, e.dataset.mmParent)[0] : (t = e.mmParent) && (n = t.closest(".mm-panel")), !t || !t.matches(".mm-listitem_vertical")) {
                    ...
                    switch (o.append(r), r.innerHTML = e.dataset.mmTitle || (a ? a.textContent : "") || this.i18n(this.opts.navbar.title) || this.i18n("Menu"), this.opts.navbar.titleLink) {
                        case"anchor":
        ...
        }, e.version = "8.4.5", e.options = i, e.configs = s, e.addons = {}, e.wrappers = {}, e.node = {}, e.vars = {}, e
    ...
    function C(e, t, n) {
        var i = t.split(".");
        e[t = "mmEvent" + A(i[0]) + A(i[1])] = e[t] || [], e[t].push(n), e.addEventListener(i[0], n)
    }

    function N(e, t) {
        var n = t.split(".");
        t = "mmEvent" + A(n[0]) + A(n[1]), (e[t] || []).forEach((function (t) {
    ...
    S.prototype.open = function () {
        ...
        this.closeAllOthers(), S.node.page.mmStyle = S.node.page.getAttribute("style") || "", function (e, t, n) {
            var i = t.split(".");
            (e[t = "mmEvent" + A(i[0]) + A(i[1])] || []).forEach((function (e) {
                e(n || {})
            }))
    ...
    S.prototype.search = function (e, t) {
        ...
        var a = e.mmSearchfield, o = g(e.closest(".mm-searchfield"), ".mm-btn"),
            r = _(this.node.pnls, ".mm-panel_search")[0], c = a.panels, l = a.noresults, m = a.listitems,
            d = a.dividers;
 ...
 */
        ...
        offcanvas: function () {
            ...
            if (this.opts.offCanvas) {
                ...
                if (t.drop) {
                    ...
                    var s = function (e, s) {
                        var a, o, r, c = s[0], l = s[1], m = "x" == e ? "offsetWidth" : "offsetHeight",
                            ...
                            g = b + i[m], _ = window[f], y = n.offset.button[e] + n.offset.viewport[e];
        ...
        angular: function () {
            ...
            if (this.node.menu.matches(".navbar-collapse")) {
                ...
                if (i) {
                    ...
                    s && (delete s.dataset.target, s.removeAttribute("aria-controls"), s.outerHTML = s.outerHTML, (s = i.querySelector(".navbar-toggler")).addEventListener("click", (function (t) {
    ...
    window.Mmenu = S, (je = window.jQuery || window.Zepto || null) && (je.fn.mmenu = function (e, t) {
        ...
        return this.each((function (i, s) {
            if (s.mmApi) return;
            let a = new S(s, e, t), o = je(a.node.menu);
