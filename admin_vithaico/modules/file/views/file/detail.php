...
//	$toolbar->addButton('Save',FSText :: _('Save'),'','save.png',1);
    ...
    $this -> dt_form_begin(1,4,$title.' '.FSText::_('Download'),'fa-edit',1,'col-md-',1);
        TemplateHelper::dt_edit_text(FSText :: _('Họ tên'),'fullname',@$data -> fullname);
//    	TemplateHelper::dt_edit_text(FSText :: _('Email'),'alias',@$data -> email,'',60,1,0,FSText::_("Can auto generate"));
...
TemplateHelper::dt_edit_text(FSText :: _('Tên file'),'file_download',@$data -> file_download);
//TemplateHelper::dt_edit_file(FSText:: _('File Download'), 'file_download', @$data->file_download);
