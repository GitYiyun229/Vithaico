...
//		}
		...
		$query = " SELECT a.id,a.title,a.category_name,a.alias,a.category_alias,a.comments_published,a.comments_total,a.comments_unread
						  FROM 
...
//		global $db;
//		$query = "select * from fs_news_comments order by created_time desc";
//		$db->query($query);
