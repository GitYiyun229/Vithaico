            ...
            <div class="col-xs-12">
                <div class='news_related_search row'>
                    <div class="row-item col-xs-6" style="margin-bottom: 20px;">
    					<select class="form-control select2"  name="news_related_category_id"  id="news_related_category_id">
					...
					<ul id='news_sortable_related'>
						...
						?>
							<li id='news_record_related_<?php echo $item ->id?>'><?php echo $item -> title; ?>
								...
								<br />
								<img  width="80" src="<?php echo URL_ROOT.str_replace('/original/','/resize/',$item->image);?>">
