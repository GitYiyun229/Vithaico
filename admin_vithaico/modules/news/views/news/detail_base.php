<div class="col-md-9">
    <div class="row">
        ...
        <div class="col-md-4 col-xs-12">
            ...
            TemplateHelper::dt_checkbox(FSText::_('Tin KM'), 'is_promotion', @$data->is_promotion, 0, '', '', '', 'col-sm-4', 'col-sm-8');
        ...
        <div class="col-md-8 col-xs-12">
            <div class="panel-heading"><i class="fa fa-info"></i> Nội dung (Nhúng sản phẩm vào nội dung nhập theo format
                {-53237-}{-58342-})</div>
            <?php
...
<div class="col-md-3" style="background: #e6e6e6; border-radius: 10px;">
    <div id="app">
        <div class="form-group">
            ...
            <div class="col-xs-12">
                <input value="<?php echo @$data->seo_main_key ?>" type="text" class="form-control" name="seo_main_key" id="seo_main_key" size="60" maxlength="100" v-model="keyword" @input="countLengthKeyword">
            </div>
        </div>
        <div class="form-group">
    ...
    padding: 5px;">Phân tích SEO</h3>
                <ul class="list-check-seo">
                    <li><i class="fa fa-circle mr-2" :class="classTextKey"></i>Độ dài từ khóa (Nên có
                        <?php echo MIN_KEY; ?> - <?php echo MAX_KEY; ?> từ)</li>
                    <li><i class="fa fa-circle mr-2" :class="classTextTitle"></i>Độ dài tiêu đề (Nên dài
                        <?php echo MIN_TITLE; ?> - <?php echo MAX_TITLE; ?> ký tự)</li>
                    <li><i class="fa fa-circle mr-2" :class="classTextDes"></i>Độ dài mô tả (Nên dài
                        <?php echo MIN_DES; ?> - <?php echo MAX_DES; ?> ký tự)</li>
                    <li><i class="fa fa-circle mr-2" :class="{'text-success': checkKey, 'text-danger': !checkKey}"></i>Từ khóa trong tiêu đề
                        chính</li>
                    <li><i class="fa fa-circle mr-2" :class="{'text-success': checkKeyDes, 'text-danger': !checkKeyDes}"></i>Từ khóa trong mô tả
                    </li>
                    <li><i class="fa fa-circle mr-2" :class="{'text-success': classWord, 'text-danger': !classWord}"></i><span>Số lượng
                            từ:</span>Nội dung có {{ countWord }} từ (Nên có ít nhất <?php echo MIN_CONTENT; ?> từ)</li>
                    <li><i class="fa fa-circle mr-2" :class="{'text-success': classInternal, 'text-danger': !classInternal}"></i><span>Internal
                            Link:</span>Nội dung có {{ countInternalLink }} link nội bộ</li>
                    <li><i class="fa fa-circle mr-2" :class="{'text-success': classExternal, 'text-danger': !classExternal}"></i><span>External
                            Link:</span>Nội dung có {{ countExternalLink }} link bên ngoài</li>
                    <li><i class="fa fa-circle mr-2" :class="{'text-success': classKeyContent, 'text-danger': !classKeyContent}"></i><span>Từ
                            khóa trong nội dung:</span>Nội dung đã có {{ countKeyContent }} từ khóa</li>
                    <li><i class="fa fa-circle mr-2" :class="{'text-success': classKeyHeading, 'text-danger': !classKeyHeading}"></i><span>Tiêu
                            đề phụ:</span>Tiêu đề phụ có {{ countKeyHeading }} từ khóa</li>
                </ul>
            </div>
        </div>
    </div>
