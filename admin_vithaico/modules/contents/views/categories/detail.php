...
TemplateHelper::dt_edit_selectbox(FSText::_('Danh mục cùng loại'), 'cat_same', @$data->cat_same, 0, $list_cat, $field_value = 'id', $field_label = 'name', $size = 1, 1, 0, '', '', '', 'col-md-3 left', 'col-md-9', '', 1, '');

//	TemplateHelper::dt_edit_image(FSText :: _('Icon'),'icon',@$data -> icon);

//$this -> dt_form_end(@$data,1,1);
$this->dt_form_end(@$data, 0, 1, 2, 'Cấu hình seo', '', 0, 'col-sm-12');
?>
