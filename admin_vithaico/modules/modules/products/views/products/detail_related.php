	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-6">
			<div id='products_related_r'>
				<!--	LIST RELATE			-->
				<div class='title-related' style="display:flex;">
                    Sản phẩm liên quan
                    <div class="hover_img"><a><i class="fa fa-comment-o" aria-hidden="true"></i>
                            <span><img src="https://lh3.googleusercontent.com/d/1o12Pn7rKqhFJLrJ4wyXOfz_c_odsI_8O"></span></a>
                    </div>
                </div>
...
<script type="text/javascript">
	...
	function set_products_related(id) {
		...
		if (length_children >= max_related) {
			alert('Tối đa chỉ có ' + max_related + ' sản phẩm');
			return;
		}
