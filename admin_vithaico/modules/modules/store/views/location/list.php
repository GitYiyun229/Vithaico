...
<?php
    ...
    $toolbar->addButtonHTML('<a class="update_btn" href="'.URL_ROOT.'index.php?module=api&view=product&task=api_update_price" target="_blank"><i class="fa fa-cloud-download" aria-hidden="true"></i><span>Update Giá SP</span></a>');
...
//	$fitler_config['text'][] = $text_to_date;
	//	CONFIG	
	$list_config = array();
$list_config[] = array('title'=>'Tên','field'=>'name','name'=> 1, 'type'=>'text');
$list_config[] = array('title'=>'Mã kho','field'=>'code','code'=> 1, 'type'=>'edit_text','arr_params'=>array('size'=>5));
