...
class OrderModelsPre_order extends FSModels
{
    var $limit;
    var $prefix;
    ...
    function __construct()
    {
        $this->limit = 40;
        $this->view = 'pre_order';
        $this->table_name = 'fs_dat_hang_truoc';
        parent::__construct();
    }
...
//        $row['district_name'] = $this->get_record('id = '.FSInput::get('district_id'),'fs_districts')->name;
    ...
    function cancel_order()
    {
        ...
        $row['is_dispute'] = 0;
        $rs = $this->_update($row, 'fs_dat_hang_truoc', ' id = ' . $order->id);
