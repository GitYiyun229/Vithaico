...
class Order_autumnControllersOrder_autumn  extends Controllers
{
...
//        echo @$arr_status1[$status1];
    ...
    function edit()
    {
        ...
        $product_new = $model->get_record('id=' . $data->products_id, 'fs_products', '*');
        $product_old = $model->get_record('id=' . $data->product_id_old, 'fs_products', '*');
//        if ($order->store) {
