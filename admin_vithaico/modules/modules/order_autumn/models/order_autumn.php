...
class Order_autumnModelsOrder_autumn extends FSModels
{
    var $limit;
    var $prefix;
    ...
    {
        $this->limit = 40;
        $this->view = 'order_autumn';
        $this->table_name = 'fs_order_autumn';
        parent::__construct();
    }
...
//        $row['note_adc'] = addslashes(FSInput::get('note_adc'));
    ...
    function cancel_order(){
        ...
        $rs = $this -> _update($row, 'fs_order_autumn', ' id = '.$id);
        return $rs;
    }
