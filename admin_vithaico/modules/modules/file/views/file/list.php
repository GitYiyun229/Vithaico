...
<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Download') );
...
//	$fitler_config['text'][] = $text_to_date;
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Họ tên','field'=>'fullname','ordering'=> 1,'align'=>'left', 'type'=>'text','col_width' => '30%');
...
//    $list_config[] = array('title'=>'Hoạt động','field'=>'published','ordering'=> 1, 'type'=>'published');
    ...
    $list_config[] = array('title'=>'file download','field'=>'file_download','ordering'=> 1, 'type'=>'text');
