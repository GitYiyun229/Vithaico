...
class StoreModelsStock extends FSModels
{
    var $limit;
    var $prefix;
    ...
    function __construct()
    {
        ...
        $this->table_name = FSTable_ad::_('fs_products_price_store', 1);
    ...
    function setQuery()
    {
        ...
        if (isset($_SESSION[$this->prefix . 'keysearch'])) {
            if ($_SESSION[$this->prefix . 'keysearch']) {
                ...
                $where .= " AND (a.title LIKE '%" . $keysearch . "%' OR a.product_code LIKE '%" . $keysearch . "%' OR a.location_code LIKE '%" . $keysearch . "%')" ;
            }
        }
        $query = " SELECT a.*
						  FROM 
