...
<div id="tabs">
    <ul>
        ...
        <!-- <li><a href="#fragment-3"><span><?php //echo FSText::_("Nội dung"); 
                                                ?></span></a></li> -->
        ...
        <!-- <li><a href="#fragment-5"><span><?php //echo FSText::_("Tin liên quan"); 
                                                ?></span></a></li> -->
        <!-- <li><a href="#fragment-6"><span><?php //echo FSText::_("Landing Page"); 
                                                ?></span></a></li> -->
        <!-- <li><a href="#fragment-8"><span><?php //echo FSText::_("Giá theo khu vực"); 
                                                ?></span></a></li> -->
    </ul>
