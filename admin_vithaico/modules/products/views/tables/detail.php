<link type="text/css" rel="stylesheet" media="all" href="<?php echo URL_ROOT_ADMIN ?>templates/default/css/select2.min.css"/>
<script type="text/javascript" src="<?php echo URL_ROOT_ADMIN ?>templates/default/js/select2.min.js"></script>
				...
				<div id="tabs" class="form-contents table-responsive">
					<table class="table table-hover table-striped table-bordered" class="field_tbl" width="100%" border="1" bordercolor="red">
						...
						<tr>
							...
							<td>
								<b data-toggle="tooltip" data-placement="left" title='<img style="height: 200px;width: auto;object-fit: cover;" src="<?php echo URL_ROOT_ADMIN ?>/images/chuthich_boloc_hienthi.png" alt="image" />'>Hiển thị</b>
							</td>
							<td><b>Lọc</b></td>
							<td><b>Chỉ Lọc</b></td>
							<td><b>Xóa</b></td>
											...
											<div class="item">
												...
												<select data-btn="btn-detail<?php echo $i ?>" data-change="group_id_exist_<?php echo $i;?>" class="select2-group select2-box" name="foreign_id_exist_<?php echo $i;?>" id='foreign_id_exist_<?php echo $i;?>' >
													...
													<?php foreach ($foreign_data as $item){
														$checked = $cat_compare == $item->id ? "selected=\"selected\"" : "";
														?>
