...
TemplateHelper::dt_edit_text(FSText::_('Thông tin bao bì'), 'summary', @$data->summary, '', 100, 6, 1, '', '', 'col-md-12 left', 'col-md-12', '', 1);
...
TemplateHelper::dt_edit_text(FSText::_('Giá chiết khấu (Thành viên)'), 'price_discount', @$data->price_discount, '', 20, 1, 0, '', '', 'col-md-4 left', 'col-md-8');
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="list-check-seo">
                <li><i class="fa fa-circle mr-2" :class="classTextKey"></i>Độ dài từ khóa (Nên có <?php echo MIN_KEY; ?>
                    - <?php echo MAX_KEY; ?> từ)
                </li>
                <li><i class="fa fa-circle mr-2" :class="classTextTitle"></i>Độ dài tiêu đề (Nên dài
                    <?php echo MIN_TITLE; ?> - <?php echo MAX_TITLE; ?> ký tự)
                </li>
                <li><i class="fa fa-circle mr-2" :class="classTextDes"></i>Độ dài mô tả (Nên dài <?php echo MIN_DES; ?>
                    - <?php echo MAX_DES; ?> ký tự)
                </li>
