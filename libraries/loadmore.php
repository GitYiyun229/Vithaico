...
//				$html .= "<a id='load_more_button' class='load_more'  data-pagecurrent='".$this->pagecurrent."' title='Next page' data-nextpage='".$this->limit."' href='javascript: void(0);' data-list='list-product-hot'><i class='fa fa-plus-circle' aria-hidden='true'></i> Xem thêm >> <i class='fa fa-plus-circle' aria-hidden='true'></i></a>";
				$html .= "<a id='load_more_button' class='load_more'  data-pagecurrent='".$this->pagecurrent."' title='Next page' data-nextpage='".$this->limit."' href='javascript: void(0);' data-list='list-product-hot'> Xem thêm >> </a>";
			}
			$html .= "</div>";
		}
