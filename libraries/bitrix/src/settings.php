...
// define('C_REST_WEB_HOOK_URL','https://ddtm.bitrix24.vn/rest/1/ybwzqvh1n5n8qld0/');//url on creat Webhook
define('C_REST_WEB_HOOK_URL',''.$config['bitrix_key'].'');//url on creat Webhook
// define('C_REST_WEB_HOOK_URL','https://ddtm.bitrix24.vn/rest/1/d16wrt7wkheltaoj/');//url on creat Webhook
