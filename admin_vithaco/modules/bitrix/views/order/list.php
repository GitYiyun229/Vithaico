...
$list_config = array();
$list_config[] = array('title' => FSText:: _('Mã đơn hàng'), 'field' => 'order_id', 'ordering' => 1, 'type' => 'text');
$list_config[] = array('title' => FSText:: _('Mã đơn Bitrix'), 'field' => 'bitrix_id', 'ordering' => 1, 'type' => 'text');
...
//$list_config[] = array('title' => FSText:: _('Hình thức thanh toán'), 'field' => 'payment_name', 'ordering' => 1, 'type' => 'text');
$list_config[] = array('title' => FSText:: _('Trạng thái Bitrix'), 'field' => 'bitrix_id', 'ordering' => 1, 'type' => 'sync_status');
//$list_config[] = array('title' => FSText:: _('Trạng thái Bitrix'), 'field' => 'bitrix_id', 'ordering' => 1, 'type' => 'sync_status');
$list_config[] = array('title' => 'Đồng bộ Bitrix', 'icon' => 'fa fa-cloud-upload', 'type' => 'link_edit', 'link' => '/index.php?module=api&view=order&task=logs_order_bitrix&id=record_id','not_rewrite'=>1);
...
$list_config[] = array('title' => FSText:: _('Ngày tạo'), 'field' => 'date', 'ordering' => 1, 'type' => 'datetime');
