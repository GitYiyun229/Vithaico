...
$list_config = array();
$list_config[] = array('title' => FSText:: _('Thứ tự'), 'field' => 'id', 'ordering' => 1, 'type' => 'text');
$list_config[] = array('title' => FSText:: _('Tên đăng kí'), 'field' => 'name', 'ordering' => 1, 'type' => 'text');
$list_config[] = array('title' => FSText:: _('Email'), 'field' => 'email', 'ordering' => 1, 'type' => 'text');
$list_config[] = array('title' => FSText:: _('Điện thoại'), 'field' => 'phone', 'ordering' => 1, 'type' => 'text');
...
$list_config[] = array('title' => FSText:: _('Ngày đăng kí'), 'field' => 'created_time', 'ordering' => 1, 'type' => 'datetime');
