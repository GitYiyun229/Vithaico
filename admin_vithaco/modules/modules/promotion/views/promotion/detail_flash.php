                        ...
                        foreach ($flash_products as $item) {
                            ...
                            <li id='products_record_related_<?php echo $item->id ?>'><?php echo $item->name; ?>
                                ...
                                <div class="box_val"
                                    ...
                                    <select class="form-control" name="discount_unit_detail_<?php echo $item->id ?>"
                                            id="discount_unit_detail_<?php echo $item->id ?>">
                                        <?php
                                        $i = 1;
                                    ...
                                    <input class="form-control" type="text" value="<?= @$data_sale_item->discount ?>"
                                           name="discount_flash_<?php echo $item->id ?>"
                                           id="discount_flash_<?php echo $item->id ?>">
                                    <input class="form-control" type="text" value="<?= @$data_sale_item->total ?>"
                                           name="total_flash_<?php echo $item->id ?>"
                                           id="total_flash_<?php echo $item->id ?>">
                                    <input class="form-control" type="text" value="<?= @$data_sale_item->ordered ?>"
                                           name="ordered_flash_<?php echo $item->id ?>"
                                           id="ordered_flash_<?php echo $item->id ?>">
                                </div>
