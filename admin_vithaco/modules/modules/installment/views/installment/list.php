...
//$list_config[] = array('title' => FSText:: _('Mã đơn hàng'), 'field' => 'id', 'ordering' => 1, 'type' => 'text');
...
$list_config[] = array('title' => FSText:: _('Giá trị'), 'field' => 'price', 'ordering' => 1, 'type' => 'format_money');
...
$list_config[] = array('title' => FSText:: _('Công ty tài chính'), 'field' => 'company_name', 'ordering' => 1, 'type' => 'text');
