...
class InstallmentModelsInstallment extends FSModels
{
    var $limit;
    var $prefix;
    ...
    function setQuery()
    {
        ...
        // ordering
        $ordering = "";
        $where = "AND `name` != 'QPbmCRVM' AND `name` != ''";
...
//			}
        ...
        if (isset($_SESSION[$this->prefix . 'keysearch'])) {
            if ($_SESSION[$this->prefix . 'keysearch']) {
                ...
                $where .= " AND ( a.id LIKE '%" . $keysearch . "%' OR name LIKE  '%" . $keysearch . "%' OR email LIKE  '%" . $keysearch . "%' 
...
//        }
        ...
        $row['admin_note'] = FSInput::get('admin_note');
...
//        $row['note_adc'] = addslashes(FSInput::get('note_adc'));
    ...
    function cancel_order(){
        ...
        $rs = $this -> _update($row, 'fs_instalment', ' id = '.$id);
        return $rs;
    }
