...
//			});
	...
	function ajax_call_comments(product_id){
		...
		$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id,type:type}, function(html){
			$('#comments_area').html(html);
			$('#unread_'+product_id).html(0);
			redisplay_comments_static_on_tabhead(product_id);
		});
	...
	function ajax_unpublished(id,product_id){
		$.get("index2.php?module=products&view=comments&task=ajax_unpublished&raw=1",{id:id,product_id:product_id}, function(status){
			if(status == 1){
				type = $('#type_comment').val();
				$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id,type:type}, function(html){
//				$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id}, function(html){
	...
	*/
	...
	function ajax_published(id,product_id){
		$.get("index2.php?module=products&view=comments&task=ajax_published&raw=1",{id:id,product_id:product_id}, function(status){
			if(status == 1){
				type = $('#type_comment').val();
				$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id,type:type}, function(html){
//				$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id}, function(html){
	...
	function ajax_del(id,product_id,published){
		if(confirm('Bạn chắc chắn muốn xóa?')){
			$.get("index2.php?module=products&view=comments&task=ajax_del&raw=1",{id:id,product_id:product_id}, function(status){
				if(status == 1){
					type = $('#type_comment').val();
					$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id,type:type}, function(html){
//					$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id}, function(html){
	...
	function submit_reply(parent_id,product_id){
		...
		$.get("index.php?module=products&view=comments&task=ajax_save_comment&raw=1",{product_id:product_id,parent_id:parent_id,name: name,text:reply_content}, function(status){
			if(status == 1){
				type = $('#type_comment').val();
				$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id,type:type}, function(html){
//				$.get("index2.php?module=product&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id}, function(html){
	...
	function submit_edit(comment_id,product_id){
		...
		$.get("index.php?module=products&view=comments&task=ajax_edit_comment&raw=1",{product_id:product_id,comment_id:comment_id,name: name,text:edit_content}, function(status){
			if(status == 1){
				type = $('#type_comment').val();
				$.get("index2.php?module=products&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id,type:type}, function(html){
//				$.get("index2.php?module=product&view=comments&task=ajax_get_comments_by_product&raw=1",{product_id:product_id}, function(html){
