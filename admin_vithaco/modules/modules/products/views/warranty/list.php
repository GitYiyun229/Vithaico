<?php
global $toolbar;
$toolbar->setTitle(FSText::_('Danh sách gói bảo hành'));
...
$list_config[] = array('title' => 'Name', 'field' => 'name', 'ordering' => 1, 'type' => 'text', 'col_width' => '20%', 'align' => 'left', 'arr_params' => array('have_link_edit' => 1));
$list_config[] = array('title' => 'Image', 'field' => 'image', 'type' => 'image', 'arr_params' => array('width' => 60, 'search' => '/original/', 'replace' => '/resized/'));

//$list_config[] = array('title' => 'Price', 'field' => 'price', 'price' => 1, 'type' => 'edit_text', 'arr_params' => array('size' => 4));
