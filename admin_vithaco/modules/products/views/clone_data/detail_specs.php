<div class="row">
    <div class="col-md-4">
        <div class="form-group row">
            <label class="col-sm-4 col-xs-12 control-label"><?php echo FSText:: _('Chọn chuyên mục chung'); ?></label>
            <div class="col-sm-8 col-xs-12">
                <select name="category_common" id="" class="form-control chosen-select chosen-select-deselect">
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group row">
            <label class="col-sm-4 col-xs-12 control-label"><?php echo FSText:: _('Trẻ em'); ?></label>
            <div class="col-sm-8 col-xs-12">
                <?php
                $checked = 0;
                $checked_all = 0;
        ...
        <div class="form-group row">
            <label class="col-sm-4 col-xs-12 control-label"><?php echo FSText:: _('Thanh niên'); ?></label>
            <div class="col-sm-8 col-xs-12">
                <?php
    ...
    <div class="col-md-4">
        <div class="form-group row">
            <label class="col-sm-4 col-xs-12 control-label"><?php echo FSText:: _('Dành cho nam'); ?></label>
            <div class="col-sm-8 col-xs-12">
                <?php
        ...
        <div class="form-group row">
            <label class="col-sm-4 col-xs-12 control-label"><?php echo FSText:: _('Dành cho nữ'); ?></label>
            <div class="col-sm-8 col-xs-12">
                <?php
    ...
    <div class="col-md-4">
        <div class="form-group row">
            <label class="col-sm-4 col-xs-12 control-label"><?php echo FSText:: _('Ngày lễ'); ?></label>
            <div class="col-sm-8 col-xs-12">
                <?php
        ...
        <div class="form-group row">
            <label class="col-sm-4 col-xs-12 control-label"><?php echo FSText:: _('Sự kiện'); ?></label>
            <div class="col-sm-8 col-xs-12">
                <?php
