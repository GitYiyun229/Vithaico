<table cellspacing="1" class="admintable">
    <?php
    $this->dt_form_begin(1, 2, FSText::_('Ảnh theo phân loại'), 'fa-photo', 1, 'col-md-12');
    TemplateHelper::dt_edit_image2(FSText::_('Ảnh khác'), 'image', str_replace('/original/', '/resized/', URL_ROOT . @$data->image), '', '', '', 1, '', 'col-md-12', 'col-md-12', 0);
    $this->dt_form_end_col();
    ?>

    <?php
    //điểm nổi bật
    //$this->dt_form_begin(1, 2, FSText::_('Điểm nổi bật'), 'fa-photo', 1, 'col-md-12');
    ...
    // $images_3d = TemplateHelper::get_other_images('products', $uploadConfig3d, 1);
    ...
    <!-- <script>
        ...
        <input type="hidden" name="session_id" id="session_id" value="<?php //$data2 = base64_decode($uploadConfig3d); $data2 = explode('|', $data2); echo $data2[1]; 
                                                                        ?>" />
    ...
    <?php //$this->dt_form_end_col(); 
    ?>

    <?php
    //ảnh từ camera
    // $this->dt_form_begin(1, 2, FSText::_('Ảnh từ camera'), 'fa-photo', 1, 'col-md-12');
    ...
    // }
    // $images_camera = TemplateHelper::get_other_images(
    //     'products',
    //     $uploadConfigcamera,
    //     2
    // );
    ...
    <!-- <script>
        ...
        <div id="camera_img">
            <input type="hidden" name="session_id" id="session_id" value="<?php //$data3 = base64_decode($uploadConfigcamera); $data3 = explode('|', $data3); echo $data3[1]; 
                                                                            ?>" />
