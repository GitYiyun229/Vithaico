...
<!-- HEAD -->
    ...
    $this -> dt_form_begin(1,4,$title.' '.FSText::_('Danh mục'),'fa-edit',1,'col-md-7',1);
        ...
        TemplateHelper::dt_edit_image(FSText :: _('Hình ảnh'),'image',URL_ROOT.@$data->image);
    	TemplateHelper::dt_checkbox(FSText::_('Published'),'published',@$data -> published,1);
        TemplateHelper::dt_checkbox(FSText::_('Hiện trái'),'is_left',@$data -> is_left,0);
        TemplateHelper::dt_checkbox(FSText::_('Hiện phải'),'is_right',@$data -> is_right,0);
