...
<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Redirect Link').' '.$_SERVER['HTTP_HOST']);
...
//	$fitler_config['text'][] = $text_to_date;
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Record ID','field'=>'record_id','ordering'=> 1,'align'=>'left', 'type'=>'text','col_width' => '10%');

	$list_config[] = array('title'=>'Alias','field'=>'alias','ordering'=> 1,'align'=>'left', 'type'=>'text_link2');
	$list_config[] = array('title'=>'Alias cũ','field'=>'old_alias','ordering'=> 1,'align'=>'left', 'type'=>'text_link2');
