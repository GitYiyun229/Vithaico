        ...
        <div class="form-contents">
            <table border="1" class="tbl_form_contents table table-hover table-striped table-bordered dataTable" bordercolor="#CCC">
                ...
                <tr>
                    ...
                    <th width="3%">
                        <input type="checkbox" class="checkbox-custom" id="checkAll_box" onclick="checkAll(<?php echo count($list); ?>);" value=""
                               name="toggle">
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            ...
                            <input type="checkbox" onclick="isChecked(this.checked);" value="<?php echo $row->id; ?>" name="cid[]"
                                   id="cb<?php echo $i; ?>" class="checkbox-custom">
                            <label for="cb<?php echo $i; ?>" class="checkbox-custom-label"></label>
